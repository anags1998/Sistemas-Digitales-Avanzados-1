...
HD_PWD='C:/Users/anags/OneDrive/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log puerto_serie.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source puerto_serie.tcl -notrace
