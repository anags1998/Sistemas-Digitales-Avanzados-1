...
HD_PWD='C:/Users/anags/OneDrive/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log puerto_serie.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source puerto_serie.tcl
