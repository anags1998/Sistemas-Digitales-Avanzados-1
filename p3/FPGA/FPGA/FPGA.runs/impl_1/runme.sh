...
HD_PWD='C:/Users/anags/OneDrive/Desktop/UNI/cuatri 2/Sistemas Digitales Avanzados/Practicas/p3/FPGA/FPGA/FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log osci.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source osci.tcl -notrace
