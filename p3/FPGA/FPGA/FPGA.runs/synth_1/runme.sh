...
HD_PWD='C:/Users/anags/OneDrive/Desktop/UNI/cuatri 2/Sistemas Digitales Avanzados/Practicas/p3/FPGA/FPGA/FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log osci.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source osci.tcl
